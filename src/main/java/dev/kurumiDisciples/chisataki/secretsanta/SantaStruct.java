...
public class SantaStruct {
    ...
    public SantaStruct(long userId, String preferredGift, String chisataki) {
        this.userId = userId;
    ...
    public static List<SantaStruct> fromResultSet(@Nonnull ResultSet set) throws SQLException {
        ...
        while(set.next()){
            list.add(new SantaStruct(set.getLong("user_id"), set.getString("preferred_gift"), set.getString("chisataki")));
        }
        return list;
    }
